function out = model_harness_create(model, component, harness_name, save_externally, harness_path, source, sink, create_without_compile)
%MODEL_HARNESS_CREATE Create a Simulink Test harness.
...
args = {'Name', harness_name, 'Source', char(string(source)), 'Sink', char(string(sink)), ...
    'SaveExternally', satkproject.str2logical(save_externally,true), 'CreateWithoutCompile', satkproject.str2logical(create_without_compile,true)};
