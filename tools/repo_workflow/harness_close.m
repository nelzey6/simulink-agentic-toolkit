function out = harness_close(model, component, harness_name, save_before_close)
%HARNESS_CLOSE Close an open Simulink Test harness.
...
if satkrepo.str2logical(save_before_close,true)
